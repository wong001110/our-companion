...
Memory retrieval is a bounded SQLite selection algorithm. SQLite remains authoritative; optional sqlite-vec rows are disposable derived state. Selection may combine structured, lexical, recency, pinned, and local Vector signals generated by Xenova/multilingual-e5-small (384 dimensions):
