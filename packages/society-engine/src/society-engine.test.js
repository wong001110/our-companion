...
import { advanceVisit, canShareKnowledge, compareVersionVectors, createKnowledgeExchangePackage, createSyncEnvelope, requestCompanionVisit, resolveSyncConflict, scoreTrust, updateRelationship } from './index';
const trust = {
...
describe('society engine', () => {
    ...
    it('uses encrypted version-vector sync envelopes and detects conflicts', () => {
        const local = createSyncEnvelope({ ownerUserId: 'user_1', payload: { title: 'Local', a: 1 }, deviceId: 'a' });
        const remote = createSyncEnvelope({ ownerUserId: 'user_1', payload: { title: 'Remote', b: 2 }, deviceId: 'b' });
