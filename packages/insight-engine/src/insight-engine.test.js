...
import { generateCognitiveInsight, generateInsights, scoreInsight, selectPrimaryInsight, InsightEngine, calculateInsightConfidence, calculateInsightImportance, calculateInsightNovelty, } from './index';
const emotion = {
    neutral: 70,
    curious: 65,
    happy: 20,
