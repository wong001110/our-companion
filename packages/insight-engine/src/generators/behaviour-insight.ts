...
export function generateBehaviourInsights(patterns: PatternV2[], memories: MemoryRecord[], userId: string): InsightV2[] {
  ...
  return [{
    ...
    userId,
    category: 'behaviour',
    title: 'Behaviour pattern insight',
    summary: `Recurring behaviour detected across ${behaviourPatterns.length} patterns.`,
    explanation: 'The user has established consistent behaviour patterns.',
