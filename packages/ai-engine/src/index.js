...
export function validateActionPlan(raw) {
    try {
...
export function validateCuriosityTargets(text) {
...
export function validateDiscoveryUnderstanding(text) {
    return discoveryUnderstandingSchema.parse(parseJsonObject(text));
}
export function validateCognitiveInsight(text) {
...
export function validateCuriosityAssessment(text) {
...
export function validateCompanionInsights(text) {
    const parsed = parseJsonObject(text);
