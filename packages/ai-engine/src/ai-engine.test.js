...
describe('ai engine', () => {
    ...
    it('validates discovery reason with card fields', () => {
        const parsed = validateDiscoveryReason('{"why_this_matters":"Useful","recommended_action":"save","short_message":"Worth keeping.","card_title":"Local-first patterns","card_body":"SQLite tools for personal memory.","tags":["sqlite"]}');
