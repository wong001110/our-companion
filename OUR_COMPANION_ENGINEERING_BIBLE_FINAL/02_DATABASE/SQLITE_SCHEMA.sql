...
CREATE TABLE IF NOT EXISTS relationships (
  ...
  journey_bond REAL NOT NULL DEFAULT 0,
  interaction_count INTEGER NOT NULL DEFAULT 0,
  accepted_discovery_count INTEGER NOT NULL DEFAULT 0,
  ignored_discovery_count INTEGER NOT NULL DEFAULT 0,
  shared_journey_count INTEGER NOT NULL DEFAULT 0,
  updated_at TEXT NOT NULL,
  FOREIGN KEY(character_id) REFERENCES characters(id)
);
...
CREATE TABLE IF NOT EXISTS preferences (
  id TEXT PRIMARY KEY,
  topic TEXT NOT NULL,
  interest_score REAL NOT NULL DEFAULT 50,
