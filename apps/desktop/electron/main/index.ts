...
function registerIpc(): void {
  const routes = {
    ...
    'discovery:listBases': services.discovery.listBases,
    'discovery:addBase': services.discovery.addBase,
    'discovery:updateBaseState': services.discovery.updateBaseState,
    'discovery:deleteBase': services.discovery.deleteBase,
    'discovery:runBaseNow': services.discovery.runBaseNow,
    'discovery:listChannels': services.discovery.listChannels,
    'discovery:updateChannelState': services.discovery.updateChannelState,
    'discovery:exploreChannelNow': services.discovery.exploreChannelNow,
    'discovery:listSuppressedPlatforms': services.discovery.listSuppressedPlatforms,
    'discovery:restoreManagedPlatform': services.discovery.restoreManagedPlatform,
    'discovery:getDiscoveryProfile': services.discovery.getDiscoveryProfile,
    ...
    'debug:getRuntimeTime': services.debug.getRuntimeTime,
    'debug:advanceRuntimeTime': services.debug.advanceRuntimeTime,
    'debug:resetRuntimeTime': services.debug.resetRuntimeTime,
    'debug:runScheduledTick': services.debug.runScheduledTick,
    'debug:runFixtureResearch': services.debug.runFixtureResearch,
    'debug:researchFromUrl': services.debug.researchFromUrl,
    'debug:getMemoryDiagnostics': services.debug.getMemoryDiagnostics,
    'debug:installLocalEmbeddingModel': services.debug.installLocalEmbeddingModel,
    'debug:rebuildMemoryVectors': services.debug.rebuildMemoryVectors,
    'debugEvents:listEvents': services.debugEvents.listEvents,
    'debugEvents:countEvents': services.debugEvents.countEvents,
    'developer:getUploadSetting': services.developer.getUploadSetting,
    'developer:setUploadSetting': services.developer.setUploadSetting,
    'developer:flushDebugEvents': services.developer.flushDebugEvents,
    'developer:getUploadStatus': services.developer.getUploadStatus,
