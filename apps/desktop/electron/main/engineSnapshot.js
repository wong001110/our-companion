...
export function buildEngineSnapshot(db, input = {}, characterId = DEFAULT_CHARACTER_ID) {
    const userId = input.userId ?? 'default';
    const focusCycle = (input.cycleId ? db.getExplorationCycle(input.cycleId) : undefined) ??
