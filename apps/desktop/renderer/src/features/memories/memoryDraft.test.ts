...
describe('memory drafts', () => {
  const node = { id: 'memory-1', type: 'topic' as const, title: 'Correct title', content: 'The saved content stays here.', summary: 'Short summary', importance: 0.5, createdAt: '', updatedAt: '' };
